...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cst/base/cstBaseBackPackPara/">备件合作包取值参数获取列表</a></li>
		<li class="active"><a href="${ctx}/cst/base/cstBaseBackPackPara/form?id=${cstBaseBackPackPara.id}">备件合作包取值参数获取<shiro:hasPermission name="cst:base:cstBaseBackPackPara:edit">${not empty cstBaseBackPackPara.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cst:base:cstBaseBackPackPara:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cstBaseBackPackPara" action="${ctx}/cst/base/cstBaseBackPackPara/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">合作代码：</label>
			<div class="controls">
				<form:input path="cooperCode" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">包名称：</label>
			<div class="controls">
				<form:input path="packageName" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">供应商名称：</label>
			<div class="controls">
				<form:input path="supplierName" htmlEscape="false" maxlength="128" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="statusChangeDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${cstBaseBackPackPara.statusChangeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="cst:base:cstBaseBackPackPara:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
