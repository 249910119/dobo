...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cp/result/cpStaffInfo/">系统人员列表</a></li>
		<li class="active"><a href="${ctx}/cp/result/cpStaffInfo/form?id=${cpStaffInfo.id}">系统人员<shiro:hasPermission name="cp:result:cpStaffInfo:edit">${not empty cpStaffInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cp:result:cpStaffInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cpStaffInfo" action="${ctx}/cp/result/cpStaffInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="staffName" htmlEscape="false" maxlength="30" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="orgName" htmlEscape="false" maxlength="15" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">full_org_name：</label>
			<div class="controls">
				<form:input path="fullOrgName" htmlEscape="false" maxlength="256" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="statusChangeDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${cpStaffInfo.statusChangeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="cp:result:cpStaffInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
