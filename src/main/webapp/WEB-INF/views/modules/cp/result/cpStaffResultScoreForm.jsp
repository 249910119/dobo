...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cp/result/cpStaffResultScore/">系统人员测评记录结果列表</a></li>
		<li class="active"><a href="${ctx}/cp/result/cpStaffResultScore/form?id=${cpStaffResultScore.id}">系统人员测评记录结果<shiro:hasPermission name="cp:result:cpStaffResultScore:edit">${not empty cpStaffResultScore.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cp:result:cpStaffResultScore:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cpStaffResultScore" action="${ctx}/cp/result/cpStaffResultScore/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">ITCode(评委)：</label>
			<div class="controls">
				<form:input path="raterId" htmlEscape="false" maxlength="20" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">姓名(评委)：</label>
			<div class="controls">
				<form:input path="raterName" htmlEscape="false" maxlength="20" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">评委类型：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">序号1：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="statusChangeDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${cpStaffResultScore.statusChangeDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="endDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${cpStaffResultScore.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="cp:result:cpStaffResultScore:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
