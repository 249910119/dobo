...
public class FcActualFeeRest implements Serializable {
	...
	public FcActualFeeRest() {
	}

	public FcActualFeeRest(String projectCode, Date calculateTime, Double financialCost, String remarks) {
		super();
	...
	public FcActualFeeRest(String projectCode, Date calculateTime, Double financialCost, Double loanRate, Double depositRate, String remarks) {
		super();
		this.projectCode = projectCode;
		this.calculateTime = calculateTime;
		this.financialCost = financialCost;
