 ...
 * @version 2016-11-06
 */
public class FcPlanOuterFee extends DataEntity<FcPlanOuterFee> {
	...
	public FcPlanOuterFee() {
		super();
	}

	public FcPlanOuterFee(String id){
		super(id);
	}

	public FcPlanOuterFee(String fcProjectInfoId, String financialMonth, String status) {
		super();
	...
	public FcPlanOuterFee(String fcProjectInfoId, String financialMonth, String status, String useFlag) {
		super();
		this.fcProjectInfoId = fcProjectInfoId;
		this.financialMonth = financialMonth;
		this.status = status;
	...
	public FcPlanOuterFee(String fcProjectInfoId, String financialMonth, Double monthBalance, Double financialCost, String status, String useFlag) {
		super();
		this.fcProjectInfoId = fcProjectInfoId;
		this.financialMonth = financialMonth;
	...
	public FcPlanOuterFee(String fcProjectInfoId, FcProjectInfo fcProjectInfo, Double financialCost,
			String financialMonth, Double monthBalance, Date calculateTime, Double loanRate, Double depositRate) {
		super();
		this.fcProjectInfoId = fcProjectInfoId;
