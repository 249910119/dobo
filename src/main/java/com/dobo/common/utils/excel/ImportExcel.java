...
public class ImportExcel {
	 ...
	 * @throws IOException
	 */
	public void getWorkbook(MultipartFile multipartFile) throws IOException{
	...
	public int getSheetNumber(){
		if (this.wb.getNumberOfSheets() == 0) {
			throw new RuntimeException("文件没有Sheet页！");
		}
	...
	public int getLastCellNum(){
		return this.getRow(headerNum)==null?0:this.getRow(headerNum).getLastCellNum();
	}
